class MusicPro {
    ...
    updateVirtualMetrics() {
        ...
        // More responsive thresholds for different screen sizes
        ...
        if (width >= 1024) {
            ...
            this.virtual.rowHeight = 124;
        } else if (width >= 768) {
            // Tablet: 2 columns
            this.virtual.itemsPerRow = 2;
            this.virtual.rowHeight = 124;
        } else {
            // Mobile: 1 column
            this.virtual.itemsPerRow = 1;
            this.virtual.rowHeight = 85;
        }
    }
        ...
        const generalItems = [
            {
                ...
                action: '<span class="status-indicator status-info">VN</span>'
            },
            {
                name: 'Cài đặt gốc',
    ...
    setCustomPrimaryColor(color) {
        ...
        // Update auth UI if it exists
        if (window.authUI) {
            window.authUI.updateAuthButtonVisibility();
        }
    }
    ...
    /**
     * Đồng bộ lời bài hát với th��i gian phát nhạc.
     */
    syncLyrics(t) {
...
// Initialize the extended MusicPro with Supabase integration after DOM is loaded
document.addEventListener('DOMContentLoaded', function() {
    // Wait a bit to ensure all scripts are loaded
    setTimeout(() => {
        if (typeof ExtendedMusicPro !== 'undefined') {
            window.app = new ExtendedMusicPro();
        } else {
            // Fallback to original if extended class is not available
