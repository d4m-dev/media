-- phpMyAdmin SQL Dump
-- Database: `my-music`
-- Full SQL script for music streaming website
...
CREATE DATABASE IF NOT EXISTS `my-music` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `my-music`;
...
-- User: admin / Password: admin (MD5: 21232f297a57a5a743894a0e4a801fc3)
