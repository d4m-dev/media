            ...
            <div id="user-bio" class="row">
                ...
                <div id="summary-and-bio" class="col-sm-7">
                    ...
                    <div id="user-summary">
                        ...
                        <?php endif; ?>
                        <p> <a href="following.php?uname=<?php echo $dest_user; ?>"><?php echo $user_info['following_count'] ?> Đang theo dõi</a> |
                            <a href="followers.php?uname=<?php echo $dest_user; ?>"><?php echo $user_info['followers_count'] ?> Người theo dõi</a></p>
                        <?php if ($logged_in_username == $dest_user): ?>
                        <p> <a href="./create_playlist.php"> Tạo danh sách phát </a> </p>
<!--                            <div data-toggle="modal" data-target="#create-playlist-modal"><span>Tạo danh sách phát</span></div>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Tạo danh sách phát mới</h4>
                                        </div>
                                        <div class="modal-body">
                                            <form method="post" action="create-playlist.php" name="create-playlist" id="create-playlist">
                                                <p>Nhập tên danh sách phát</p>
                                                <input type="text"/>
                                                <p>Riêng tư hay Công khai?</p>
                                                <input type="radio" value="1" name="pop" checked/>Công khai
                                                <input type="radio" value="0" name="pop" checked/>Riêng tư
                                                <input type="submit" value="Tạo danh sách phát"/>
                                            </form>
                            ...
                            <div class="col-sm-3">
                                <form action="FollowUnfollow.php" method="post" class="artist-like-form">
                                    ...
                                    <?php if ($user_info['does_follow'] == 1): ?>
                                        <input type="checkbox" class="" id="follow-check" name="follow-check" checked> Theo dõi
                                    <?php else: ?>
                                        <input type="checkbox" class="" id="follow-check" name="follow-check"> Theo dõi
                                    <?php endif; ?>
                    ...
                    <?php if (isset($_GET['success'])): ?>
                        <div class="col-sm-5" id="success-msg">
                            <?php if ($user_info['does_follow'] == 1): ?>
                                <p class="alert alert-success">Bạn đã theo dõi <?php echo $dest_user; ?></p>
                            <?php else: ?>
                                <p class="alert alert-info">Bạn đã hủy theo dõi <?php echo $dest_user; ?></p>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <?php if ($user_info['fav_artists']): ?>
                <div id = "fav-artists">
                    ...
                    <?php else: ?>
                        <h3>Nghệ sĩ yêu thích của <?php echo $dest_user . ":"; ?></h3>
                    <?php endif; ?>
                    <ul id="fav-artist-songs-headers" class="row playload">
                        <li class="song-header-cnt col-sm-2">#</li>
                        <li class="song-header-title col-sm-10">TÊN NGHỆ SĨ</li>
            ...
            <?php else: ?>
                <?php if ($logged_in_username == $dest_user): ?>
                    <h3>Nghệ sĩ yêu thích của bạn:</h3>
                    <p><i>Bạn chưa thích nghệ sĩ nào!</i></p>
                <?php else: ?>
                    <p><i><?php echo $dest_user ?> chưa thích nghệ sĩ nào</i></p>
                <?php endif; ?>
            <?php endif; ?>
            </br></br></br>
            ...
            <?php if ($user_info['self_playlist']): ?>
                <div id = "top-songs">
                    <?php if ($logged_in_username == $dest_user): ?>
                        <h3>Danh sách phát của bạn:</h3>
                    <?php else: ?>
                        <h3>Danh sách phát của <?php echo $dest_user . ":"; ?></h3>
                    <?php endif; ?>
                    <ul id="top-songs-headers" class="row pay-load">
                        <li class="song-header-cnt col-sm-2">#</li>
                        <li class="song-header-title col-sm-10">TÊN DANH SÁCH PHÁT</li>
            ...
            <?php else: ?>
                <h3>Danh sách phát của bạn:</h3>
                <?php if ($logged_in_username == $dest_user): ?>
                    <p><i>Bạn chưa có danh sách phát nào!</i></p>
                <?php else: ?>
                    <p><i><?php echo $dest_user ?> chưa có danh sách phát công khai nào!</i></p>
                <?php endif; ?>
            <?php endif; ?>
