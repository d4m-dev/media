                ...
                <div id="artist-bio" class="row">
                    ...
                    <div id="summary-and-bio" class="col-sm-7">
                        ...
                        <div id="artist-summary">
                            <h1>Bài hát của <?php echo ucwords($artist_info['artist_title']); ?></h1>
                            <a href=""><p><?php echo $artist_info['track_count']; ?> Bài hát</a> | <?php echo $artist_info['like_count'] ?> Lượt thích</p>
                        </div>
                        <!-- Displaying Artist Summary -->
                            ...
                            <div class="col-sm-3">
                                <form action="likeUnlikeArtistAction.php" method="post" class="artist-like-form">
                                    ...
                                    <?php if ($artist_info['does_like'] == 1): ?>
                                        <input type="checkbox" class="" id="like-check" name="like-check" checked> Thích
                                    <?php else: ?>
                                        <input type="checkbox" class="" id="like-check" name="like-check"> Thích
                                    <?php endif; ?>
                                    <input type="hidden" name="destination" value="<?php echo $_SERVER["REQUEST_URI"]; ?>"/>
                                    <button type="submit"  class="form-sbmt-btn btn btn-default">Gửi</button>
                                </form>
                            </div>
                        </div>
                        <?php if (isset($_GET['success'])): ?>
                            <div class="col-sm-4" id="success-msg">
                                <?php if ($artist_info['does_like'] == 1): ?>
                                    <p class="alert alert-success">Bạn đã thích <?php echo $artist_title; ?></p>
                                <?php else: ?>
                                    <p class="alert alert-info">Bạn đã bỏ thích <?php echo $artist_title; ?></p>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Bài hát hàng đầu</a>
                            </h3>
                        </div>
                        <div id="collapse1" class="panel-collapse collapse in">
                            <?php if ($artist_info['top_songs']): ?>
                                ...
                                ?>
                            <?php else: ?>
                                <p>Chưa có bài hát nào được đánh giá!</p>
                            <?php endif; ?>
                        </div>
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Tất cả bài hát</a>
                                </h3>
                                <div id="collapse2" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        ?>
                                    <?php else: ?>
                                        <p>Chưa có bài hát nào của <?php echo $artist_info['artist_title'] ?>!</p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
